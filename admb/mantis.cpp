...
model_data::model_data(int argc,char * argv[]) : ad_comm(argc,argv)
{
  ...
  rec_n_yr.allocate("rec_n_yr");
  rec_month_yr.allocate(1,rec_n_yr,"rec_month_yr");
 ...
 model_data(argc,argv) , function_minimizer(sz)
{
  ...
  surv_50.allocate(20,100,1,"surv_50");
  surv_slope.allocate(0.01,2,1,"surv_slope");
  fish_50.allocate(20,100,1,"fish_50");
  ...
  molt_50.allocate(20,200,-1,"molt_50");
  molt_slope.allocate(-2,2,-1,"molt_slope");
  f.allocate("f");
  ...
  surv_sel.allocate(1,size_n,"surv_sel");
    ...
    surv_sel.initialize();
  #endif
  molt_prob.allocate(1,size_n,"molt_prob");
  #ifndef NO_AD_INITIALIZE
    molt_prob.initialize();
  #endif
  ...
  IsB0.initialize();
  #endif
  fut_mort.allocate("fut_mort");
  #ifndef NO_AD_INITIALIZE
  fut_mort.initialize();
  #endif
  fut_rec.allocate("fut_rec");
  #ifndef NO_AD_INITIALIZE
  fut_rec.initialize();
  #endif
}
...
void model_parameters::find_bzero(void)
{
  int nn; int j;
  // Find B0
  IsB0 = 0;
