...
plot_rec_est[params$rec_months]<-outs[[1]]$recruits/div_n
plot(plot_rec_est~params$all_months,type='l',ylim=c(0,max(outs[[1]]$recruits)/div_n),las=1,
     ylab='',xaxt='n',lwd=2)

plot_rec_true<-exp(outs_complex$recruitment)/div_n
